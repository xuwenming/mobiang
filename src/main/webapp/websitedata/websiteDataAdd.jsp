...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/websiteDataController/add',
			onSubmit : function() {
		...
		<form id="form" method="post" enctype="multipart/form-data">		
			...
			<table class="table table-hover table-condensed">
				<tr>	
					...
					<td colspan="3">
						<input class="span2" name="title" type="text" style="width: 200px"/>
					</td>	
				</tr>
				<tr>	
				...
				<tr>	
					...
					<td width="42%">
						<input name="seq" value="10" class="easyui-numberspinner"
							style="width: 140px; height: 29px;" required="required"
							data-options="editable:true,min:100">
					</td>	
